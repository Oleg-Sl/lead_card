...
export const SMART_ID_CALCULATION = 145;
...
export const CALCULATION_FABRICS_FIELDS = [
    'fabricNumber1',
    'fabricNumber2',
    'fabricNumber3',
];
export const SMART_FIELDS_CALCULATION = {
    dateCreated: 'createdTime',                           // Начало расчета                            Дата
