...
//     async search(body) {
//         try {
//             const response = await fetch(`${this.api}user.search`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
...
//     async get(body) {
//         try {
//             const response = await fetch(`${this.api}user.get`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
...
//     async getItem(entityTypeId, id) {
//         try {
//             const response = await fetch(`${this.api}crm.item.get`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
...
//             const res = await response.json();
//             console.log("Smart process get = ", res);
//             return res?.result;
//         } catch (error) {
//             console.error(error);
//         }
...
//     async getFilter(body) {
//         try {
//             const response = await fetch(`${this.api}crm.item.list`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
...
//             const res = await response.json();
//             console.log("Smart process get list = ", res);
//             return res?.result;
//         } catch (error) {
//             console.error(error);
//         }
...
//     async getList(entityTypeIds, dealId) {
//         try {
...
//                 if (entityTypeId) {
//                     reqPackage[entityTypeId] = `crm.item.list?entityTypeId=${entityTypeId}&filter[parentId2]=${dealId}`;
//                 }
//             }
...
//             const res = await response.json();
//             console.log("Smart process get Batch = ", res);
...
//         }
//         try {
//             const response = await fetch(`${this.api}crm.contact.list`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
